...
<html lang="<?php echo e(config('app.locale')); ?>">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('css/animate.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(url('css/font-awesome.min.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(url('css/font.css')); ?>" type="text/css" cache="false" />
    <link rel="stylesheet" href="<?php echo e(url('css/plugin.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(url('css/app.css')); ?>" type="text/css" />
    <!--[if lt IE 9]>
      <script src="<?php echo e(url('js/ie/respond.min.js')); ?>" cache="false"></script>
      <script src="<?php echo e(url('js/ie/html5.js')); ?>" cache="false"></script>
      <script src="<?php echo e(url('js/ie/fix.js')); ?>" cache="false"></script>
    <![endif]-->
  ...
  <body>
    ...
    <script src="<?php echo e(url('js/app.plugin.js')); ?>"></script>
    <script src="<?php echo e(url('js/app.data.js')); ?>"></script>
